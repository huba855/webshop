...
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Fender Player Stratocaster MN 3-Color Sunburst', 229900, 'Konstrukció: csavarozott nyak<br> Test: éger<br> Nyak: jávor, modern C profil<br> Menzúra: 648 mm<br> Fogólap: jávor<br> Érintők: 22 medium jumbo<br> Hangszedők: 3x Player Series Alnico 5 Strat Single-Coil pickup<br> Elektronika: 5-állású kapcsoló, hangerő, 2 hangszín<br> Híd: 2-Point Synchronized Tremolo with Bent Steel Saddles<br> Szín:(BCMS: Black Cherry Metallic Satin)', 'gitar3.jpg', 0)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Epiphone Les Paul Modern Figured Magma Orange Fade', 229900, 'Test: Mahogany / AAA Lángolt juhar fedlap<br> Nyak: Mahogany<br> Fogólap: Ében<br> Menzúra: 24.72\" / 628mm<br> Bundok: 22 Medium jumbo<br> Hangszedők: ProBucker-2 humbucker w/coil-splitting<br> ProBucker-3 humbucker w/coil-splitting<br> Elektronika: 2 Volume w/coil splitting and treble bleed, 2-Tone with phase switching<br> Híd: LockTone ABR<br> Hangolókulcsok: Grover Locking Rotomatic tuners with Tulip Buttons with an 18:1 ratio<br> Szín: Magma Orange Fade', 'gitar4.jpg', 0)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Jackson King V KV Gloss Black', 324900, 'Jackson Pro Series elektromos gitár<br> Test: mahagóni<br> Nyak: juhar<br> Menzúra: 648 mm<br> Fogólap: ébenfa<br> Bundok: 24 Jumbo<br> Híd: Floyd Rose 1000 Series Double-Locking Tremolo (süllyesztett)<br> Hangszedők: Seymour Duncan Distortion TB-6 (híd), Seymour Duncan Distortion SH-6N (nyak)<br> Elektronika: 3 állású kapcsoló, hangerő, hangszín<br> Szín: Gloss Black', 'gitar5.jpg', 0)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Ibanez IEGS6, 09-42 gitárhúr', 1890, 'Ibanez nikkelezett húrkészlet elektromos gitárhoz<br> Húrvastagságok: .009/.011/.016/.024/.032/.042<br> Super Light', 'kieg1.jpg', 3)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Dunlop - Max Grip Standard pengető', 250, 'Méretek:<br> 0.60 mm<br> 0.73 mm<br> 0.88 mm<br> 1.0 mm<br> 1.14 mm<br> 1.5 mm', 'kieg2.jpg', 3)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Warwick RCL 30253 D6 gitárkábel', 1990, '3 m / 10 ft.,<br> Pipás - döntött 1/4 csatlakozó, Műanyag házban<br> Külső átmérő :7 mm / 0.28<br> Colour: black<br> Aranyozott bevonat a csatlakozó hegyén', 'kieg3.jpg', 3)");
$db->exec("INSERT INTO termekek(nev, ar, leiras, kep, typeId) VALUES('Warwick Rockbag Basic Line Szólógitár Tok', 5000, 'Puha tok vékony béléssel, szólógitárhoz<br> Vízlepergető anyag', 'kieg4.jpg', 3)");
